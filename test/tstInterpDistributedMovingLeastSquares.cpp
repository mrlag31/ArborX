                              ...
                              ARBORX_DEVICE_TYPES)
{
  ...
  Kokkos::View<point0 *, MemorySpace> srcp0("srcp", 1);
  Kokkos::View<point0 *, MemorySpace> tgtp0("tgtp", 1);
  Kokkos::View<double *, MemorySpace> srcv0("srcv", 1);
  Kokkos::View<double *, MemorySpace> tgtv0("tgtv", 1);
  Kokkos::parallel_for(
  ...
  ArborX::Interpolation::DistributedMovingLeastSquares<MemorySpace, double>
      dmls0(mpi_comm, space, srcp0, tgtp0, 2,
            ArborX::Interpolation::CRBF::Wendland<0>{},
            ArborX::Interpolation::PolynomialDegree<1>{});
  auto eval0 = dmls0.apply(space, srcv0);
  ...
  Kokkos::View<point1 *, MemorySpace> srcp1("srcp", 3);
  Kokkos::View<point1 *, MemorySpace> tgtp1("tgtp", 2);
  Kokkos::View<double *, MemorySpace> srcv1("srcv", 3);
  Kokkos::View<double *, MemorySpace> tgtv1("tgtv", 2);
  Kokkos::parallel_for(
      "for", Kokkos::RangePolicy<ExecutionSpace>(space, 0, 1),
      KOKKOS_LAMBDA(int const) {
